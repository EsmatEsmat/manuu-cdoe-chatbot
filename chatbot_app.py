...
<style>
    ...
    .stChatMessage[data-testid="stChatMessage"]:has(p:lang(ur)) { direction: rtl !important; text-align: right !important; }
...
if action == "Edit FAQ":
    ...
    if st.button("Save Changes"):
        ...
        st.success("FAQ Saved Successfully! Please refresh to apply.")
else:
    # Branding
    st.markdown('''
    <div style="text-align: center;">
        ...
        <div style="font-size: 15px; margin-top: 5px;">Centre for Distance and Online Education</div>
